    ...
    <div className="w-full">
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-slate-600 text-lg leading-relaxed">
                ...
                <p>
                  What started as a small team with a big vision has grown into a trusted IT services company. We believe that every business, regardless of size, deserves access to world-class digital tools.
                </p>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-14">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">
              From web development to digital marketing, we offer a comprehensive suite of IT services.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              { title: "Reliable & Secure", desc: "Fast, secure and high-performance solutions you can trust." },
              { title: "Latest Technology", desc: "We use modern tools to build fast, secure, and efficient solutions." },
              { title: "100% Client Satisfaction", desc: "We are committed to delivering exceptional results that exceed your expectations." },
            ].map((item, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 16 }}
      ...
      <section className="py-16 bg-primary text-white text-center">
        <div className="container mx-auto px-4">
          ...
          <Link href="/contact">
            <Button variant="outline" size="lg" className="rounded-full h-14 px-10 text-lg bg-white text-primary hover:bg-white/90 border-white">
              Get in Touch
            </Button>
          </Link>
        </div>
